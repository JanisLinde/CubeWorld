...
public:
	EntityListClass();
	EntityListClass(const EntityListClass& other);
	~EntityListClass();

	void SetOnlineStatus(bool online);
	void SetId(unsigned short iud);
	...
	void UpdatePosition(float positionX, float positionY, float positionZ, float rotationX, float rotationY, float rotationZ);
	void UpdateRotateState(bool rotate);
